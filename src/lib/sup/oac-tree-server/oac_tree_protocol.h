...
#ifndef SUP_OAC_TREE_SERVER_SUP_OAC_TREE_PROTOCOL_H_
#define SUP_OAC_TREE_SERVER_SUP_OAC_TREE_PROTOCOL_H_
...
#endif  // SUP_OAC_TREE_SERVER_SUP_OAC_TREE_PROTOCOL_H_
