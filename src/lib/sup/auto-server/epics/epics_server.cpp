...
EPICSServer::EPICSServer(const AnyValueManagerInterface::NameAnyValueSet& name_value_set)
  : m_update_queue{}
  , m_update_future{}
{
...
void EPICSServer::UpdateLoop(const AnyValueManagerInterface::NameAnyValueSet& name_value_set)
{
