...
EPICSServer::EPICSServer(const IAnyValueManager::NameAnyValueSet& name_value_set)
  : m_update_queue{}
  , m_update_future{}
{
...
void EPICSServer::UpdateLoop(const IAnyValueManager::NameAnyValueSet& name_value_set)
{
